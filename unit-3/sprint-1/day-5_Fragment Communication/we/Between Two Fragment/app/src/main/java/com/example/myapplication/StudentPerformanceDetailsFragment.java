...
public class StudentPerformanceDetailsFragment extends Fragment {
    ...
    private void initViews(View view) {
        mEtStudentGrade = view.findViewById(R.id.etStudentGrade);
        mEtStudentPercentage = view.findViewById(R.id.etStudentPercentage);
        mBtnPreview = view.findViewById(R.id.btnPreview);
        mBtnPreview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String grade = mEtStudentGrade.getText().toString();
                String percentage = mEtStudentPercentage.getText().toString();
