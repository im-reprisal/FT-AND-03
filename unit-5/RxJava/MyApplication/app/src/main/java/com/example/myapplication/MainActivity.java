...
public class MainActivity extends AppCompatActivity {
    ...
    private final String TAG = "CheckByNishant";
    ...
    private void fromArrayButtonClicked() {
        mBtnFromArrayButton.setOnClickListener(view -> {
            String[] name = {"Niket", "Nishant", "Nayan", "Rishab"};
    ...
    private List<StudentDetails> getStudentDetails() {
        ...
        for (int i = 0; i < 100; i++) {
            StudentDetails studentDetails = new StudentDetails("1st", i, "Nishant");
            StudentDetails studentDetails1 = new StudentDetails("1st", i, "Nayan");
            StudentDetails studentDetails2 = new StudentDetails("1st", i, "Niket");
            StudentDetails studentDetails3 = new StudentDetails("1st", i, "Rishab");
            StudentDetails studentDetails4 = new StudentDetails("1st", i, "Ram");
